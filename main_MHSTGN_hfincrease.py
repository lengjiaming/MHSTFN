...
def train_main(mean,std,his_adj_mx,trans_adj_mx):
    ...
    for epoch in range(start_epoch, epochs):
        ...
        with open('result_hefei_increase_new/train_losses_count_link16_lr2-4_prot256_k4.txt', 'a', encoding='utf-8') as file:
...
if __name__ == "__main__":
    ...
    # predict_main(134,test_loader, test_target_tensor, _mean, _std, 'test')
