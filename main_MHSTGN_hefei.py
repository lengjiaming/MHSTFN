...
import argparse
import configparser
from model.MHSTGN_hefei_copy import make_model
from lib.utils_MHSTGN_hefei import *
...
def train_main():
    ...
    for epoch in range(start_epoch, epochs):
        ...
        with open('result_hefei_aaai/train_losses_w_HSTFus.txt', 'a', encoding='utf-8') as file:
