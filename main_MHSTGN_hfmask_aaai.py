...
import argparse
import configparser
from model.MHSTGN_hefei_mask import make_model
from lib.utils_MHSTGN_hefei_mask import *
...
parser.add_argument("--config", default='configurations/my_hefei_mask.conf', type=str,
...
graph_signal_matrix_filename = data_config['graph_signal_matrix_filename2']
...
def train_main(mean,std,his_adj_mx,trans_adj_mx):
    ...
    for epoch in range(start_epoch, epochs):
        ...
        with open('result_hefei_mask_new/train_losses_count_link16_lr2-4_prot256_k4.txt', 'a', encoding='utf-8') as file:
